...
public class NodeUser {
     ...
     * 
     * @param userList 格式为 user01#DP1002$T10003,user02#DP1003$NodeT0005
     * @param nodeid 为要分析的节点id，指定节点id则只返回此nodeid的用户和部门map对像，如果要返回所有用户和部门的map则nodeid传入*号
