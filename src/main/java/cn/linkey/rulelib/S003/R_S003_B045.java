...
import cn.linkey.workflow.wf.MessageImpl;
...
public class R_S003_B045 implements LinkeyRule {
    private static Logger logger = LoggerFactory.getLogger(R_S003_B045.class);
    ...
    public String run(HashMap<String, Object> params) throws Exception {
        ...
        if (Tools.isNotBlank(nodeDoc.g("OutDataConfig"))) {
            ...
            if (i < 1) {
                ...
                logger.error(nodeDoc.g("OutDataConfig") + "数据流出错误!");
                return "";
            }
        }
