...
public class R_S003_B016 implements LinkeyRule {
    ...
    private static Logger logger = LoggerFactory.getLogger(R_S003_B016.class);
    ...
    public String run(HashMap<String, Object> params) throws Exception {
        ...
        if (Tools.isBlank(runNodeid)) {
           // BeanCtx.log("E", "未传入要运行的节点id=" + runNodeid);
            logger.error("未传入要运行的节点id=" + runNodeid);
            return "";
        }
        logger.info("R_S003_B016要结束的节点=" + runNodeid);
        ...
        for (String taskNodeid : previousNodeSet) {
            ...
            logger.info("结束userTask节点=" + taskNodeid);
