...
/**
 * 强制启动用户任务 参数说明: 1.需要在Params中传入WF_NextNodeid节点Nodeid参数只能传一个 3.需要在Params中传入WF_NextUserList作为目的节点要启动的用户列表 4.需要在Params中传入WF_Remark作为审批意见
 * @author admin
 *  8.0
 *  2014-11-22 22:07
 */
final public class R_S003_B072 implements LinkeyRule {
    ...
    public String run(HashMap<String, Object> params) throws Exception {
        ...
        String returnMsg = BeanCtx.getMsg("Engine", "StartUser", userList);
