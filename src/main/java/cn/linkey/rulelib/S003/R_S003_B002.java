    ...
    public String run(HashMap<String, Object> params) throws Exception {
        ...
        if (nextNodeidSet != null && nextNodeidSet.size() != 0) {
            ...
            for (String targetNodeid : nextNodeidSet) {
                ...
                if (linkeywf.isDebug()) {
                    ...
                    logger.info("Debug:获得流程(" + processid + ")原节点(" + runNodeid + ")与目标节点(" + targetNodeid + ")之间的路径=" + routerPathSet.toString());
                }
            }
        ...
        if (linkeywf.isDebug()) {
           // BeanCtx.out("Debug:已知到所有目标节点的全部路径集合=" + params.get("WF_AllRouterPath"));
            logger.info("Debug:已知到所有目标节点的全部路径集合=" + params.get("WF_AllRouterPath"));
        }
